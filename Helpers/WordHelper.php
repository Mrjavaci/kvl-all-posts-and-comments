...
class WordHelper
{
    ...
    public function getAllWords()
    {
        ...
        foreach ($filePaths as $fileName) {
            ...
            array_push($allContentsAndComments, $content);
            $ex = explode(" ", $content);
            foreach ($ex as $str) {
        ...
        if (SaveAllData) {
            file_put_contents("AllContentsAndComments.json", json_encode($allContentsAndComments));
        }
    ...
    private function getAllFilePaths(): array
    {
        ...
        foreach ($datasFolder as $folder) {
            ...
            foreach ($files as $file) {
                array_push($filesArray, __DIR__ . "/datas/" . $file);
            }
        }
        return $filesArray;
    }
